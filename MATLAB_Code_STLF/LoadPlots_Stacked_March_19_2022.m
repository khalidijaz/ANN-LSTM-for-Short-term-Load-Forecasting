...
data8 = num(:,8) ;% Predcitedion by EMD LSTM
...
subplot(7,1,7)
plot(xData,data1','LineWidth',LW,'color','r'); hold on;
plot(xData,data8','LineWidth',LW,'color','b'); hold off;
datetick('x','mm/dd/yyyy','keepticks','keeplimits'); 
AX=legend('Target Load','Load Predicted by EMD-LSTM');
AX.FontSize =10;
title('(g)');
...
filename1 = sprintf('Target_Load_vs_7_predicted_loads.pdf');
